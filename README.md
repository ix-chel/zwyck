...
```
python3 zwyck.py -s yahoo.com --save filename.txt
```
Scan for  subdomains but also extract subdomains from shodan
```
python3 zwyck.py -s yahoo.com --shodan API_KEY --save filename.txt
```
Scan for javascript files 
```
python3 zwyck.py -j yahoo.com --depth 4 --save jsfiles.txt -c 20
```
Scan for dns records
```
python3 zwyck.py -d domains.txt
```
Scan for FavIcon hashes 
```
python3 zwyck.py -fi domain.com
```
Web Crawler
```
python3 zwyck.py -wc https://www.domain.com
```
Broken Links
```
python3 zwyck.py -b https://www.domain.com
```
Cors Misconfiguration Scan
```
python3 zwyck.py -co domains.txt
```
Host Header Injection
```
python3 zwyck.py -hh domains.txt
```
Host Header Injection With proxy
```
python3 zwyck.py -hh domains.txt --proxy http://proxy.com:8080
```
Directory Brute Forcing
```
python3 zwyck.py --directorybrute domain.com --wordlist list.txt --threads 50 -e php,txt,html -x 404,403
```
Directory Brute Forcing with no extensions
```
python3 zwyck.py --directorybrute domain.com --wordlist list.txt --threads 50 -x 404,403
```
Scanning a subnet
```
python3 zwyck.py --cidr_notation IP/24 --ports 80,443 --threads 200
```
Directory Traversal
```
python3 zwyck.py -ph domain.com?id=
```   
sql injection
```
python3 zwyck.py -sqli domain.com?id=1
```   
xss
```
python3 zwyck.py -xss domain.com?id=1
```
JavaScript file scanning for sensitive info
```
python3 zwyck.py -javascript domain.com
```
Javascript endpoint fuzzing
```
python3 zwyck.py -javascript_endpoint domains.txt -c 20 --save filename.txt
```
Modify the headers of the request
```
python3 zwyck.py -ch domain.com
```
Parameter bruteforcing
```
python3 zwyck.py -pf domain.com
```
Open Redirect
```
python3 zwyck.py -or domain.com -v -c 50
```
Haveibeenpwned
```
python3 zwyck.py -hibp password
```
Subdomain Takeover
```
python3 zwyck.py -st domains.txt --save vuln_subs.txt -c 50 
```
Auto Recon
```
python3 zwyck.py -ar domain.com
```
JSON Web Token
```
python3 zwyck.py -jwt Token
```
JSON Web Token Modification
```
python3 zwyck.py -jwt-modify Token
```
AWS S3 Bucket Enumeration
```
python3 zwyck.py --s3-scan bucket.com
```
Heap Dump Analysis 
```
python3 zwyck.py --heapdump heapdump_file
```
